...
def vectorize(device, documents, model_name="&", verbose=None, gpu=False):
...
def load_preprocess_vectors_train(INPUT_PATH="", title_content="", abstract_content="", inclusion_content="", MODEL="",
                                  device="", default_embeddings=False, save=False):
    """
    ...
    if default_embeddings:
        ...
        title_vectors, abstract_vectors, inclusion_vectors = vectorize_all(title_content, abstract_content,
                                                                           inclusion_content, MODEL, device, save)
...
def load_preprocess_vectors_test(title_content="", abstract_content="", inclusion_content="", MODEL="", device="",
                                 save=False):
    """
